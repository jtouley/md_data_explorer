...
**Location**: After line 841 (after classifications check)

Add guard to ensure relationships are detected before BFS:
...
**Location**: Line 938-944 (join operation)

Add `validate="m:1"` parameter to the join:
...
- **Determinism**: Stable join order for reproducible results