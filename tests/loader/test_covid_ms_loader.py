...
from clinical_analytics.datasets.covid_ms.loader import clean_data, load_raw_data
...
class TestCOVIDMSLoader:
    ...
    def test_clean_data_basic(self):
        ...
        df = pl.DataFrame({"sex": ["M", "F", None, "M"], "age": [45, 62, 38, 50]})
    ...
    def test_clean_data_with_mapper(self):
        ...
        df = pl.DataFrame({"sex": ["M", "F", "M"], "outcome_source": ["yes", "no", "yes"]})
    ...
    def test_clean_data_without_mapper(self):
        ...
        df = pl.DataFrame({"sex": ["M", "F", None], "age": [45, 62, 38]})
