...
class TestStats:
    ...
    def test_run_logistic_regression_single_predictor(self):
        ...
        df = pd.DataFrame({"outcome": [0, 1, 0, 1, 0, 1], "age": [20, 30, 40, 50, 60, 70]})

        model, summary_df = run_logistic_regression(df, outcome_col="outcome", predictors=["age"])
